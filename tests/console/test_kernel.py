...
class TestKernelCLI(TestCase):
    ...
    def testIgnoreFlagsIsFrozenset(self) -> None:
        """
        Test that IGNORE_FLAGS is a frozenset.

        Ensures the type constraint required by processing logic is met and
        that membership checks are O(1).
        """
