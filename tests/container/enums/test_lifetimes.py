...
class TestLifetime(TestCase):
    ...
    def testLookupByValueReturnsCorrectMember(self) -> None:
        """
        Construct a Lifetime from an integer value and return the correct member.
    ...
    def testLookupByNameReturnsCorrectMember(self) -> None:
        """
        Access a Lifetime member via name string and return the correct member.
    ...
    def testReprContainsClassAndName(self) -> None:
        """
        Verify repr() of a Lifetime member contains the class name and member name.
